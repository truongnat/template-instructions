...
class HealthMonitor:
    ...
    def check_health(self) -> HealthStatus:
        ...
        src_dir = self.project_root / "src" # Assuming src structure, or tools for this repo
        # usage in this repo is a bit different, checking tools/
        tools_dir = self.project_root / "tools"
        if not tools_dir.exists():
             issues.append("Missing tools/ directory")
             score -= 20
