...
Usage:
    python tools/workflows/sprint.py start 5    # Start sprint 5
    python tools/workflows/sprint.py status     # Show current sprint status
    python tools/workflows/sprint.py close 5    # Close sprint 5
"""
...
try:
    ...
    from utils.artifact_manager import get_current_sprint, set_current_sprint
except ImportError:
...
"""
    ...
    print(f"  3. Run: python tools/workflows/sprint.py start {sprint_number + 1}")
