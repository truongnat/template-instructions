...
class InputScorer:
    ...
    def _score_completeness(self, text: str) -> float:
        ...
        bonus = min(keyword_count * 0.05, 0.2)
    ...
    def _score_specificity(self, text: str) -> float:
        ...
        base = 0.3
        base += min(keyword_count * 0.1, 0.3)
        base += 0.15 if has_numbers else 0
        base += 0.15 if has_technical else 0
    ...
    def _score_actionability(self, text: str) -> float:
        ...
        base = 0.3
        base += min(action_count * 0.15, 0.5)
