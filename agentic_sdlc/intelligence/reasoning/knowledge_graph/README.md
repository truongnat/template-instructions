# Memgraph Brain - Universal Document Storage & Self-Learning

Sync ALL project documents to Memgraph Cloud (or local instance) and enable AI self-learning through pattern recognition.
...
```
MEMGRAPH_URI=bolt://your-instance.databases.memgraph.io
...
python agentic_sdlc/intelligence/knowledge_graph/sync_skills_to_memgraph.py --dry-run
python agentic_sdlc/intelligence/knowledge_graph/sync_skills_to_memgraph.py --stats-only
```

### 2. document_sync.py
Syncs ALL document types to Memgraph.

```bash
# Sync all documents
python agentic_sdlc/intelligence/knowledge_graph/document_sync.py --all

# Sync specific types
python agentic_sdlc/intelligence/knowledge_graph/document_sync.py --type plans
python agentic_sdlc/intelligence/knowledge_graph/document_sync.py --type reports
python agentic_sdlc/intelligence/knowledge_graph/document_sync.py --type artifacts
python agentic_sdlc/intelligence/knowledge_graph/document_sync.py --type workflows

# Preview without syncing
python agentic_sdlc/intelligence/knowledge_graph/document_sync.py --dry-run

# View statistics
python agentic_sdlc/intelligence/knowledge_graph/document_sync.py --stats-only
```
...
python agentic_sdlc/intelligence/knowledge_graph/learning_engine.py --setup

# Record error patterns
python agentic_sdlc/intelligence/knowledge_graph/learning_engine.py --record-error "TypeError" "Cannot read X of undefined" \
    --resolution "Added null check" --approach "defensive_coding"

# Record success patterns
python agentic_sdlc/intelligence/knowledge_graph/learning_engine.py --record-success "task-123" \
    --task-type "auth_feature" --success-approach "JWT with refresh tokens"

# Get recommendations
python agentic_sdlc/intelligence/knowledge_graph/learning_engine.py --recommend "implement user authentication"

# Find similar errors
python agentic_sdlc/intelligence/knowledge_graph/learning_engine.py --similar-errors "ConnectionError"

# Find reasoning paths
python agentic_sdlc/intelligence/knowledge_graph/learning_engine.py --reasoning-path "TypeError" "null check"

# View statistics
python agentic_sdlc/intelligence/knowledge_graph/learning_engine.py --stats
python agentic_sdlc/intelligence/knowledge_graph/learning_engine.py --patterns
```
...
```bash
# Get recommendations
python agentic_sdlc/intelligence/knowledge_graph/learning_engine.py --recommend "your task description"
```

### After Bug Fix
```bash
# Record error pattern
python agentic_sdlc/intelligence/knowledge_graph/learning_engine.py --record-error "ErrorType" "Error message" \
...
python agentic_sdlc/intelligence/knowledge_graph/learning_engine.py --record-success "task-id" \
...
```bash
# Run all Memgraph tests
pytest tests/test_document_sync.py tests/test_learning_engine.py -v

# Run integration tests (requires Memgraph connection)
...
#memgraph #knowledge-graph #self-learning #documents
