...
- ✅ `write:milestones` - Create and update milestones
...
📋 Creating milestone: Sprint 3
✅ Milestone created: Sprint 3 (due: 2026-01-15)

📝 Creating issues:
  ✅ Issue #42: [PM] Create project plan
  ✅ Issue #43: [DEV] Implement authentication
  ✅ Issue #44: [QA] Test login flow

🏷️  Applying labels:
  ✅ role:pm, priority:high, type:planning
  ✅ role:dev, priority:high, type:feature
  ✅ role:qa, priority:medium, type:testing
...
📋 Would create milestone: Sprint 3
📝 Would create issues:
  • [PM] Create project plan
  • [DEV] Implement authentication
  • [QA] Test login flow

🏷️  Would apply labels:
  • role:pm, priority:high, type:planning
  • role:dev, priority:high, type:feature
  • role:qa, priority:medium, type:testing
...
- [ ] Bi-directional sync (GitHub → Artifacts)
