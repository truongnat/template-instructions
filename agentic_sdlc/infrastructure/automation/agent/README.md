...
```bash
# List all roles
python agentic_sdlc/infrastructure/agent/manage.py list role

# List all workflows
python agentic_sdlc/infrastructure/agent/manage.py list workflow

# List all templates
python agentic_sdlc/infrastructure/agent/manage.py list template

# List all rules
python agentic_sdlc/infrastructure/agent/manage.py list rule
```
...
```bash
# Create a new role
python agentic_sdlc/infrastructure/agent/manage.py create role architect

# Create a new workflow
python agentic_sdlc/infrastructure/agent/manage.py create workflow deploy

# Create a new template
python agentic_sdlc/infrastructure/agent/manage.py create template api-spec

# Create a new rule
python agentic_sdlc/infrastructure/agent/manage.py create rule deployment
```
...
```bash
# Validate a role
python agentic_sdlc/infrastructure/agent/manage.py validate role dev

# Validate a workflow
python agentic_sdlc/infrastructure/agent/manage.py validate workflow cycle

# Validate a template
python agentic_sdlc/infrastructure/agent/manage.py validate template project-plan

# Validate a rule
python agentic_sdlc/infrastructure/agent/manage.py validate rule global
```
...
```bash
# Show role info
python agentic_sdlc/infrastructure/agent/manage.py info role pm

# Show workflow info
python agentic_sdlc/infrastructure/agent/manage.py info workflow cycle

# Show template info
python agentic_sdlc/infrastructure/agent/manage.py info template project-plan

# Show rule info
python agentic_sdlc/infrastructure/agent/manage.py info rule global
```
...
# Validate it
python agentic_sdlc/infrastructure/agent/manage.py validate role architect

# Show info
python agentic_sdlc/infrastructure/agent/manage.py info role architect
```
...
for role in brain pm dev devops; do
  python agentic_sdlc/infrastructure/agent/manage.py validate role $role
done
```
...
python agentic_sdlc/infrastructure/agent/manage.py create workflow deploy
python agentic_sdlc/infrastructure/agent/manage.py create workflow rollback
python agentic_sdlc/infrastructure/agent/manage.py create workflow monitor

# Validate all
python agentic_sdlc/infrastructure/agent/manage.py validate workflow deploy
python agentic_sdlc/infrastructure/agent/manage.py validate workflow rollback
python agentic_sdlc/infrastructure/agent/manage.py validate workflow monitor
```
