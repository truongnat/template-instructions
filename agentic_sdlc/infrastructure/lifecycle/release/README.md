...
### Preview Changes
```bash
python agentic_sdlc/infrastructure/release/release.py preview
```

### Generate Changelog
```bash
# Auto-detect version bump
python agentic_sdlc/infrastructure/release/release.py changelog

# Specify sprint number
python agentic_sdlc/infrastructure/release/release.py changelog --sprint 5

# Specific version
python agentic_sdlc/infrastructure/release/release.py changelog --version 1.2.0
```

### Bump Version
```bash
# Auto-detect based on commits
python agentic_sdlc/infrastructure/release/release.py version --auto

# Specific bump type
python agentic_sdlc/infrastructure/release/release.py version --bump minor
```

### Full Release
```bash
# Release with auto-detected version
python agentic_sdlc/infrastructure/release/release.py release

# Release with git tag
python agentic_sdlc/infrastructure/release/release.py release --tag --bump minor
```
...
python agentic_sdlc/infrastructure/release/release.py release --bump minor --tag --sprint 5
...
```bash
# Quick patch release
python agentic_sdlc/infrastructure/release/release.py release --bump patch
...
```bash
python agentic_sdlc/infrastructure/release/release.py changelog --dry-run
python agentic_sdlc/infrastructure/release/release.py release --dry-run
```
