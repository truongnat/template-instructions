...
Usage:
    python tools/validation/validate.py           # Full validation
    python tools/validation/validate.py --fix     # Suggest fixes
    python tools/validation/validate.py --report  # Generate report file
"""
